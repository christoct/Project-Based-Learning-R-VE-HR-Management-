...
1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5V15a.75.75 0 0 1 1.5 0v3.75a3
    ...
    <div class="bar">
        <button type="submit" form="form_input_pekerjaan" class="save_karyawan">Simpan</button>
        <span class="cancel_karyawan" id="cancel_deskripsi"> Batal</span>
        <span class="tittle_input">Pekerjaan Baru</span>
    </div>

    <div class="container">
        <form action="proses_input_pekerjaan.php" method="POST" id="form_input_pekerjaan">
            <input type="text" class="main_input" name="pekerjaan_diinput" id="nama_pekerjaan"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="nama_pj_display" class="add_input" placeholder="Otomatis Terisi"
                            readonly>
                        <input type="hidden" name="penanggung_jawab" id="text_PN">
                    </td>
                </tr>
            </table>
            <span class="text_input" id="keterangan_desc">Deskripsi Pekerjaan</span><br>
            <textarea name="deskripsi" id="text_desc" cols="120" rows="10" class="desc"
