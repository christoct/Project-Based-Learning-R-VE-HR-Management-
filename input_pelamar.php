...
1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5V15a.75.75 0 0 1 1.5 0v3.75a3
    ...
    <div class="bar">
        <span class="save_pelamar" id="save_pelamar">Simpan</span>
        <span class="cancel_karyawan" id="cancel_pelamar"> Batal</span>
        <span class="tittle_input">Pelamar Baru</span>
    </div>

    <div class="container">
        <form action="proses_input_pelamar.php" id="input_pelamar" method="POST" enctype="multipart/form-data">
            <label class="upload_container">
                ...
                <input type="file" name="profil_pelamar" id="file_profile_pelamar" class="foto_karyawan"
                    accept="image/*">
            </label>
            <input type="text" name="nama_pelamar" class="main_input" placeholder="Nama Pelamar Baru">
            <select name="lowongan_dipilih" id="" class="sub_select">
            ...
            <table class="add_table">
                <tr>
                    ...
                    <td>
                        <input type="text" name="telepon_pelamar" class="add_input" placeholder="co. 087726503008">
                    </td>
                    <td class="text_input">Alamat Email</td>
                    <td>
                        <input type="email" name="email_pelamar" class="add_input"
                ...
                <tr>
                    ...
                    <td>
                        <select name="recruiter" id="" class="add_select">
                    ...
                    <td>
                        <select name="interviewer" id="" class="add_select">
                ...
                <tr>
                    ...
                    <td>
                        <select name="status_lamaran" id="" class="add_select">
                    ...
                    <td>
                        <input type="text" name="linkedln" class="add_input"
