...
<script src="update_delete_nilai_akhir.js"></script>
...
<body>
    ...
    <form action="proses_input_nilai_akhir.php" id="form_input_nilai_akhir" method="POST">
        <div class="popup" id="input_nilai">
            <span class="x">&times;</span>
            <span class="popup_tittle">Tambah Nilai Akhir</span>
            <hr class="line">
            <table class="data">
                <tr>
                    <td class="popup_text">Nama Nilai Akhir </td>
                    <td class="popup_data">
                        <input type="text" name="nama_nilai_akhir" placeholder="co. Sangat Memuaskan"
                            class="popup_input">
                    </td>
                </tr>
            </table>
            ...
            <span class="save" id="simpan_nilai_akhir">Simpan</span>
        </div>
    </form>

    <form action="proses_update_nilai_akhir.php" id="form_update_nilai_akhir" method="post">
        <div class="popup" id="update_nilai">
            <span class="x">&times;</span>
            <span class="popup_tittle">Ubah Nilai Akhir</span>
            <hr class="line">
            <input type="hidden" name="id_nilai_akhir_update" id="id_nilai_akhir_update">
            <table class="data">
                <tr>
                    <td class="popup_text">Nama Nilai Akhir </td>
                    <td class="popup_data">
                        <input type="text" name="nama_nilai_akhir_update" id="nama_nilai_akhir_update"
                            placeholder="co. Sangat Memuaskan" class="popup_input">
                    </td>
                </tr>
            </table>
            <br>
            <hr class="line">
            <span class="close" id="hapus_nilai">Hapus</span>
            <span class="save" id="simpan_update_nilai_akhir">Simpan</span>
        </div>
    </form>

    <form action="proses_hapus_nilai_akhir.php" method="post" id="form_hapus_nilai">
        <div class="popup" id="hapus_nilai_popup">
            <input type="hidden" name="id_nilai_akhir_hapus" id="id_nilai_akhir_hapus">
            <span class="x">&times;</span>
            <span class="popup_tittle">Hapus Nilai Akhir</span>
            <hr class="line">
            <span class="popup_text" id="nama_nilai_akhir_hapus">Apakah Anda yakin mau menghapus nilai akhir ini?</span>
            <br>
            <div class="popup_buttons">
                <span class="ya" id="confirm_hapus_nilai">Ya</span>
...
1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5V15a.75.75 0 0 1 1.5 0v3.75a3
    ...
    <div class="bar"> <span class="new_penilaian" id="new_nilai">Baru</span>
        <span class="tittle_penilaian">Nilai Akhir</span>
        <div class="wadah_search"><input type="text" id="search_input" class="search_bar" id="search_input"
                placeholder="Cari Nama Nilai..">
            <div class="search">
...
5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
    ...
    <div class="wadah_nilai">
        <table class="tabel_nilai">
            ...
            WHERE nama_nilai_akhir LIKE '%$keyword%'";
            } else {
                $sql = "SELECT *FROM nilai_akhir";
            }
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo ("<tr class='data_nilai'>
                    <td class='isi_data_nilai'>" . $row["nama_nilai_akhir"] . "
                    </td>
                    <input type='hidden' class='id_nilai_akhir' value='" . $row["id_nilai_akhir"] . "'>
            <input type='hidden' class='nama_nilai_akhir' value='" . $row["nama_nilai_akhir"] . "'>
                    </tr>");
                }
            } else {
                echo ("<tr class=''>
                    <td class='isi_data_nilai'> 0 results
                    </td>
                    </tr>");
            }
            ?>
