...
1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5V15a.75.75 0 0 1 1.5 0v3.75a3
    ...
    <div class="bar">
        <button type="submit" form="update_karyawan" class="save_karyawan" id="simpan_karyawan">Simpan</button>
        <span class="cancel_karyawan" id="cancel_karyawan"> Batal</span>
        <span class="tittle_input">Ubah Karyawan</span>
    </div>

    <div class="container">
        <form action="proses_update_karyawan.php" id="update_karyawan" method="POST" enctype="multipart/form-data">
            <label class="upload_container">
                ...
                <input name="foto_karyawan_update" id="foto_karyawan_update" type="file" class="foto_karyawan"
            ...
            <select name="id_pekerjaan" id="id_pekerjaan_update" class="sub_select">
            ...
            <table class="add_table">
                <tr>
                    ...
                    <td>
                        <input id="email_update" name="email_kantor_karyawan" type="email" class="add_input"
                ...
                <tr>
                    ...
                    <td>
                        <input id="telepon_kerja_update" name="telepon_kantor_karyawan" type="text" class="add_input"
                ...
                <tr>
                    ...
                    <td>
                        <select name="spesifikasi_kerja_update" id="spesifikasi_kerja_update" class="add_select">
            ...
            <table class="add_table">
                <tr>
                    ...
                    <td>
                        <input id="nik_update" name="nik_update" type="text" class="add_input"
                            placeholder="co. 237625448009">
                    </td>
                    <td class="text_input">Jenis Kelamin</td>
                    <td>
                        <select name="jenis_kelamin_update" id="jenis_kelamin_update" class="add_select">
                ...
                <tr>
                    ...
                    <td>
                        <input name="umur_update" id="umur_update" type="number" min="18" max="60" step="1"
                            class="add_number" placeholder="18 - 60 tahun">
                    </td>
                    <td class="text_input">Jumlah Anak</td>
                    <td>
                        <input name="jumlah_anak_update" id="jumlah_anak_update" type="number" min="0" step="1"
                ...
                <tr>
                    ...
                    <td>
                        <select name="status_kawin_update" id="status_kawin_update" class="add_select">
                    ...
                    <td>
                        <input name="alamat_update" id="alamat_update" type="text" class="add_input"
