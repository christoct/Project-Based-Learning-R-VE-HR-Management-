...
<body>
    ...
    $sql = "SELECT slip_gaji.* , kontrak_kerja.nama_kontrak,
    slip_gaji.jumlah_gaji AS total_gaji,
    struktur_gaji.nama_struktur, 
    struktur_gaji.jumlah_gaji AS jumlah_gaji,
    struktur_gaji.interval_gaji, rekening_karyawan.nama_bank,
    rekening_karyawan.nomor_rekening
    FROM slip_gaji
    JOIN kontrak_kerja ON slip_gaji.id_karyawan = kontrak_kerja.id_karyawan
    JOIN struktur_gaji ON kontrak_kerja.id_struktur_gaji = struktur_gaji.id_struktur_gaji
    JOIN rekening_karyawan ON rekening_karyawan.id_karyawan = slip_gaji.id_karyawan
    WHERE id_slip_gaji = '$id_slip_gaji'";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            $jumlah_pembayaran = $row["total_gaji"] / $row["jumlah_gaji"];
            echo ("<input type='hidden' id='id_slip_gaji_ambil' value='" . $row["id_slip_gaji"] . "'>");
            echo ("<input type='hidden' id='id_karyawan_ambil' value='" . $row["id_karyawan"] . "'>");
            echo ("<input type='hidden' id='nama_kontrak_ambil' value='" . $row["nama_kontrak"] . "'>");
            echo ("<input type='hidden' id='nama_struktur_ambil' value='" . $row["nama_struktur"] . "'>");
            echo ("<input type='hidden' id='jumlah_gaji_ambil' value='" . $row["jumlah_gaji"] . "'>");
            echo ("<input type='hidden' id='interval_gaji_ambil' value='" . $row["interval_gaji"] . "'>");
            echo ("<input type='hidden' id='metode_bayar_ambil' value='" . $row["metode_bayar"] . "'>");
            echo ("<input type='hidden' id='status_pembayaran_ambil' value='" . $row["status_pembayaran"] . "'>");
            echo ("<input type='hidden' id='total_gaji_ambil' value='" . $row["total_gaji"] . "'>");
            echo ("<input type='hidden' id='nama_bank_ambil' value='" . $row["nama_bank"] . "'>");
            echo ("<input type='hidden' id='nomor_rekening_ambil' value='" . $row["nomor_rekening"] . "'>");
            echo ("<input type='hidden' id='tanggal_cetak_ambil' value='" . $row["tanggal_cetak"] . "'>");
            echo ("<input type='hidden' id='jumlah_pembayaran_ambil' value='" . $jumlah_pembayaran . "'>");
        }
    } else {
        echo "Gagal akses data profil";
    }
...
1.5 0 0 0 1.5 1.5h6a1.5 1.5 0 0 0 1.5-1.5V15a.75.75 0 0 1 1.5 0v3.75a3
    ...
    <div class="bar">
        <span class="save_pelamar" id="simpan_update_slip">Simpan</span>
        <span class="cancel_karyawan" id="kembali_slip"> Kembali</span>
        <span class="tittle_input">Ubah Slip Gaji</span>
    </div>

    <div class="container">
        <form action="proses_update_slip.php" id="form_update_slip" method="POST">
            <input type="hidden" name="id_slip_gaji_update" id="id_slip_gaji_update">
            <span class="id" id="id_update_display">SL/001</span><br>
            <select name="id_karyawan_update" id="id_karyawan_update" class="main_select">
            ...
            <input type="text" id="nama_kontrak_update" class="sub_input" placeholder="Nama Kontrak (Otomatis)"
                readonly>
            ...
            <table class="add_table">
                <tr>
                    ...
                    <td>
                        <input id="nama_struktur_update" type="text" class="add_input" placeholder="Otomatis Terisi"
                            readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input id="jumlah_gaji_display" type="text" class="add_input" placeholder="Otomatis Terisi"
                            readonly>
                        <input type="hidden" name="jumlah_gaji_update" id="jumlah_gaji_update">
                    </td>
                </tr>
                <tr>
                    <td class="text_input">Bayar Gaji Untuk</td>
                    <td>
                        <input id="jumlah_pembayaran_update" type="number" min="1" step="1" class="satuan_number"
                            placeholder="Satuan">
                        <span class="text_input" id="interval_gaji_update"></span>
                    </td>
                </tr>
            </table>
            <span class="">
                ...
                <table class="add_table">
                    <tr>
                        ...
                        <td>
                            <input type="text" id="total_gaji_display" class="add_input" placeholder="Otomatis Terisi"
                                readonly>
                        </td>
                        <td><input type="hidden" name="total_gaji_update" id="total_gaji_update"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td class="text_input">Metode Bayar</td>
                        <td>
                            <select name="metode_bayar_update" id="metode_bayar_update" class="add_select">
                                <option value="" disabled selected hidden class="placeholder">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="nomor_rekening_update" type="text" class="add_input"
            ...
            <span class="">
                ...
                <table class="add_table">
                    <tr>
                        ...
                        <td>
                            <select name="status_pembayaran_update" id="status_pembayaran_update" class="add_select">
                                <option value="" disabled selected hidden class="placeholder">
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="tanggal_cetak_display" type="text" class="add_input"
                                placeholder="Otomatis Terisi" readonly>
                        </td>
                        <td><input type="hidden" name="tanggal_cetak_update" id="tanggal_cetak_update"></td>
                        <td></td>
                    </tr>
                </table>
            </span>
